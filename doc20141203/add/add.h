...
typedef struct {
  void *_private;
void (*addInts)(PortableServer_Servant _servant, const CORBA_short input_a, const CORBA_short input_b, CORBA_Environment *ev);
} POA_AddApp_Add__epv;
typedef struct {
...
/** skel prototypes **/
void _ORBIT_skel_small_AddApp_Add_addInts(POA_AddApp_Add *_ORBIT_servant, gpointer _ORBIT_retval, gpointer *_ORBIT_args, CORBA_Context ctx,CORBA_Environment *ev, void (*_impl_addInts)(PortableServer_Servant _servant, const CORBA_short input_a, const CORBA_short input_b, CORBA_Environment *ev));

/** stub prototypes **/
void AddApp_Add_addInts(AddApp_Add _obj, const CORBA_short input_a, const CORBA_short input_b, CORBA_Environment *ev);
...
typedef enum {
	AddApp_Add_addInts__imethods_index
